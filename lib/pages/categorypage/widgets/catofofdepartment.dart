                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      height: 60,
                      child:
                          SearchingitemRow(searchController: _searchController),
                    ),
                  ),
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return state
                                    is GetCategoriesOfDepartmentsLoadingState
                                ? Center(
                                    child: CircularProgressIndicator(),
                                  )
                                : CatofDitem(
                                    categoriesOfDepModel: HomeCubit.get(context)
                                        .categoriesofdepartmentsList[index],
                                  );
                          },
